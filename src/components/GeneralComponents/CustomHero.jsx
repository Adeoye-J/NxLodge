...
const CustomHero = () => {
    ...
    return (
        <div>
            <div 
                style={{backgroundImage: 'url("/images/home_assets/seaview.jpg")', backgroundBlendMode: "color" }} 
            ...
            >
                <div className="w-full h-full bg-blue-950/80 absolute top-0 left-0 flex flex-col items-center justify-center">
                    <div className="py-20 md:py-10 flex flex-col items-center justify-center gap-5 md:gap-12">
                        <h2 className='text-3xl md:text-6xl font-extrabold font-sansita md:w-[70%]'>Explore Available <span className='text-blue-600'>Properties</span> With Ease</h2>
