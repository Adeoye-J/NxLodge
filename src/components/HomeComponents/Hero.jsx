        ...
        >
            <div className="w-full h-full bg-blue-950/70 absolute top-0 left-0 flex flex-col items-center justify-center">
                <div className="py-20 md:py-10 flex flex-col items-center justify-center gap-5 md:gap-12">
                    <h2 className='text-3xl md:text-5xl font-bold font-sansita'>Find Your <span className='text-blue-300'>Perfect Lodge</span> With Ease</h2>
                    ...
                    <button className='border-2 p-2 max-sm:text-sm font-semibold md:py-3 rounded-md hover:scale-95 transition-all duration-500 md:w-[400px]'>Get Started</button>
                </div>
            </div>
        </div>
    )
